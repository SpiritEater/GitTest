...
# '/a./' - С помощью этого шаблона можно найти все вхождения символа а (здесь а для примера - можно найти любой другой символ) с любым символом.
...
# Точка (.) в регулярных выражениях отвечает за любой другой символ.
